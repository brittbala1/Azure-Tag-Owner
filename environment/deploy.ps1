$resourceGroupName = "Test123"            # <-- REPLACE the variable values with your own values.
$location = "australiasoutheast"                 # <-- Ensure that the location is a valid Azure location
$storageAccountName = "Testfunctionsdev007"           # <-- Ensure the storage account name is unique
$appServicePlanName = "AustraliaSoutheastPlans"   # <--
$appInsightsName = "axyfunctionsdev"              # <--
$functionName = "axyzfunctionsdev"                 # <--
